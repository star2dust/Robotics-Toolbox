...
rob.plot([0,0,ed(3)/2+ed(1)/6,0,0,0,0,0],'frame','workspace',[-1,3,-1,3,0,4]);
q0 = [0,0,ed(3)/2+ed(1)/6,0,0,0,0,0];
q1 = [1,0,ed(3)/2+ed(1)/6,0,0,-1,1,2];
q2 = [1,1,ed(3)/2+ed(1)/6,0,0,1,2,1];
