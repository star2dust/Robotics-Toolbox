...
for i = 1:quad.nrotors
    ...
    set(h.rotor(i),'xdata',[hub(1,i)+tippath(1,:,i)],'ydata',[hub(2,i)+tippath(2,:,i)],'zdata',[hub(3,i)+tippath(3,:,i)]);
end
...
for i = 1:quad.nrotors
    ...
    set(h.line(i),'xdata',[hub(1,i) hub0(1)],'ydata',[hub(2,i) hub0(2)],'zdata',[hub(3,i) hub0(3)]);
    
    % plot a circle at the hub itself
    set(h.hub(i),'xdata',[hub(1,i)],'ydata',[hub(2,i)],'zdata',[hub(3,i)]);
end
end