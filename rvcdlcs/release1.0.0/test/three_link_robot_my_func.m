% three-link robot kinematics and dynmaics calculation using my functions
...
[M1,C1,N1] = dymat(m,I,xi,th,dth,g_sl0,{g,b});
%% robot dynamics
for i=1:n
...
% run the following codes to check the validity of function
% simplify(M-M1)
% simplify(C-C1)
% simplify(N-N1)
